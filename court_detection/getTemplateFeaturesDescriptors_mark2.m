function [templateFeatures , templateDescriptors , pos] = getTemplateFeaturesDescriptors_mark2(template_in)
...
[templateFeatures , templateDescriptors] = vl_sift(template_gray , 'PeakThresh',5); % For synthetic court/grass court templates(aus/us open)
