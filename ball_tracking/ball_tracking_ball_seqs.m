...
ballDetection_video_out = ['/Neutron9/anurag/AO_2017_segments/ball_track/',num2str(seq_nb),'_TEST_BALL_DETECTION.avi'];
...
[candidate_per_frame , mov , len, buffer_len] = temporalDifference_mark3(video_file,candidate_video_out,background_in,0,result_bbox_upper , result_frame_upper , result_bbox_lower , result_frame_lower);
